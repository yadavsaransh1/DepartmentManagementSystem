...
export const TeacherProject = () => {
  ...
  const fetchAssignedStudents = async () => {
    try {
      setLoading(true);
      const response = await api.get(`/supervisors/teacher/${user.id}/students`);
      setAssignedStudents(Array.isArray(response.data) ? response.data : []);
    ...
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: '20px' }}>
        ...
        <div style={{
          ...
          <h3 style={{ marginTop: 0, marginBottom: '15px' }}>Assigned Students ({assignedStudents.length})</h3>
          ...
          {loading ? (
            ...
            assignedStudents.map(student => (
              ...
              >
                <div style={{ fontWeight: 'bold', fontSize: '13px' }}>{student.fullName}</div>
        ...
        {selectedStudent ? (
          <div>
            ...
            <div style={{
              ...
              <h2 style={{ marginTop: 0, marginBottom: '10px' }}>{selectedStudent.fullName}</h2>
                  ...
                  {documents.map(doc => (
                    ...
                    >
                      <div style={{ flex: 1, fontSize: '13px' }}>
                        <div style={{ fontWeight: 'bold', marginBottom: '3px' }}>{doc.fileName}</div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
                ...
                >
                  {showMessagesPanel ? 'Hide' : 'Show'} Messages
                </button>
              </div>
